  ...
  const packages = [
    {
      ...
      price: "$12,000",
      details: [
        "Haldi Ceremony – Fun-filled turmeric ritual by the beach.",
        "Mehendi Ceremony – Henna application with music and dance.",
        "Wedding Ceremony – Traditional rituals under a floral mandap by the sea.",
        "Simple Beach Décor – Minimal yet elegant.",
    ...
    },
    {
      ...
      details: [
        ...
        "Cocktail Party – Bonfire, music, and drinks on the beach.",
        ...
        "Pre-Wedding Beach Photoshoot – With traditional & casual themes.",
        "Live Dhol & DJ Night – High-energy Punjabi or Bollywood beats.",
        "Seafood & Traditional Buffet – Customized beachside menu.",
      ],
    },
    {
      ...
      details: [
        ...
        "Luxury Beach Villa Stay – Stay in premium beachside villas.",
  ...
  return (
    <div style={{ fontFamily: "Times New Roman, serif", color: "white" }}>
      ...
      <div style={{ position: "relative" }}>
        ...
        >
          <h1 style={{ fontSize: "3.5rem", fontWeight: "bold" }}>Beach Weddings</h1>
          <p style={{ fontSize: "1.4rem" }}>
            Celebrate your love on the serene shores of Kerala, Goa, and the Andaman Islands.
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          <Modal.Title>Beach Wedding Booking</Modal.Title>
        </Modal.Header>
